...
from modules.keypoints import extract_keypoints, extract_keypoints_batch, group_keypoints, group_keypoints_fast
...
def postprocess_optimized_batch_k20_fast(heatmaps, pafs, original_hw, stride=8):
    orig_h, orig_w = original_hw
...
if __name__ == '__main__':
    ...
    variants = [
        ...
        ('optimized_batch_k20_fast', postprocess_optimized_batch_k20_fast),
