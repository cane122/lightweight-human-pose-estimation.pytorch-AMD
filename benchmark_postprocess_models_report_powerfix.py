...
def postprocess_optimized_batch_timed(
    ...
    with Timer() as t:
        poses, kpts = group_keypoints(all_kpts, pafs) # type: ignore
    timings["group_ms"] = t.ms
...
def postprocess_optimized_batch_timed_fast(
    results,
    original_hw,
    engine,
    max_keypoints_per_type=20,
    ...
    with Timer() as t:
        poses, kpts = group_keypoints_fast(all_kpts, pafs) # type: ignore
    timings["group_ms"] = t.ms
...
def postprocess_optimized_batch_k20_timed_fast(results, original_hw, engine):
    return postprocess_optimized_batch_timed_fast(
        results,
        original_hw,
        engine,
        max_keypoints_per_type=20,
...
def benchmark_one_model(
    ...
    variants = [
        ...
        ("optimized_batch_k20_fast", postprocess_optimized_batch_k20_timed_fast),
